...
return array(
    ...
    array(
        'name'    => __('Image Background Parallax', 'omega-admin-td'),
        ...
        'desc'    => __('Set the way the background scrolls with the page. Scroll = normal Fixed = Parallax effect.', 'omega-admin-td'),
    ),
    array(
