...
function oxy_shortcode_section( $atts , $content = '') {
    ...
    $background_media_style = ( $has_media && !$has_video ) ? 'background-image: url(\''. $background_image_url .'\'); background-repeat:'. $background_image_repeat .'; background-size:'.$background_image_size.'; background-attachment:'. $background_image_attachment.'; background-position-y:'. $background_position_vertical.'%;': "";
...
function oxy_shortcode_menu( $atts, $content = '' ) {
    extract( shortcode_atts( array(
        ...
        'menu_capitalization'    => 'menu_capitalization',
