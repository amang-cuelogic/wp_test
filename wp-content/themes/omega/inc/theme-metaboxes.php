...
$oxy_theme->register_metabox( array(
    ...
    'fields' => array(
        ...
        array(
            'name'    => __('Show Top Navigation', 'omega-admin-td'),
            'desc'    => __('Show or hide the sites top navigation (ideal for landing pages).', 'omega-admin-td'),
            'id'      => 'site_top_nav',
            'type' => 'select',
            'default' => 'show',
            'options' => array(
        ...
        array(
            'name'    => __('Override Top Navigation Swatch', 'omega-admin-td'),
            'desc'    => __('Override the default site top nav swatch (only for this page).', 'omega-admin-td'),
            'id'      => 'site_top_swatch',
            'type' => 'select',
            'default' => '',
            'options' => array_merge( array(
                '' => __('Default Top Nav Swatch', 'omega-admin-td'),
            ), $default_swatches )
        ),
        array(
