 ...
 */
?>
<div class="<?php echo implode( ' ', $classes ); ?>" data-padding="<?php echo $item_padding; ?>" data-col-xs="<?php echo $xs_col; ?>" data-col-sm="<?php echo $sm_col; ?>" data-col-md="<?php echo $md_col; ?>" data-col-lg="<?php echo $lg_col; ?>">
    <?php
